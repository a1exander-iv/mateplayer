...
class FavoriteScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => FavoriteScreenCubit(context.read<DatabaseRepository>())..init(),
      child: Scaffold(
          appBar: AppBar(
            toolbarHeight: 56,
            title: Text(
                ...
                slivers: [
                          ...
                          return Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  AppLocalizations.of(context)!.favoritePlaylistsHeadline,
                      ...
                      child: Builder(builder: (context) {
                        if (state.favoriteTrackData.isNotEmpty) {
                          return Column(
                            ...
                            children: [
                              Text(
                                AppLocalizations.of(context)!.favoriteTracksHeadline,
                                style: isMobileLayout
                                    ? textTheme.headlineMedium
                                    : textTheme.headlineLarge,
                              ),
                  ...
                  SliverPadding(
                      padding: EdgeInsets.only(
                          ...
                          left: leftContentPadding,
                          right: rightContentPadding),
                      sliver: TrackList(audioList: state.favoriteTrackData)),
                ],
              );
            } else {
              return const SizedBox.shrink();
